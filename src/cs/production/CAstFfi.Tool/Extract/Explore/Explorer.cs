...
public sealed partial class Explorer
{
    ...
    private readonly ImmutableDictionary<CKind, Extract.Explore.ExploreHandler> _handlers;
    ...
    private static ImmutableDictionary<CKind, Extract.Explore.ExploreHandler> CreateHandlers(IServiceProvider services)
    {
        var result = new Dictionary<CKind, Extract.Explore.ExploreHandler>
        {
