...
public sealed partial class ClangArgumentsBuilder
{
    ...
    private void AddTargetTriple(ImmutableArray<string>.Builder args, CTargetPlatform platform)
    {
    ...
    private ImmutableArray<string> SystemIncludeDirectories(
        ...
        ImmutableArray<string> frameworks)
    {
        var hostOperatingSystem = NativeUtility.HostOperatingSystem;
        var hostArchitecture = NativeUtility.HostArchitecture;
