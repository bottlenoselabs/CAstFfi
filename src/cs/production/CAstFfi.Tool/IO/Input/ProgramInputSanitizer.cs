...
using CAstFfi.IO.Input.Unsanitized;
using CAstFfi.Native;

namespace CAstFfi.IO.Input;
...
public sealed class ProgramInputSanitizer
{
        ...
        string inputFilePath)
    {
        ...
        {
            var abstractSyntaxTreeRequests = new Dictionary<CTargetPlatform, UnsanitizedTargetPlatformOptions>();
            var targetPlatform = NativeUtility.HostPlatform;
        ...
        string inputFilePath)
    {
        ...
        var outputFilePath = VerifyOutputFilePath(options.OutputDirectory, targetPlatform);
