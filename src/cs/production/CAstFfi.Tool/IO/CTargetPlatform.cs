...
using CAstFfi.IO.Serialization;
...
public record struct CTargetPlatform(string TargetName)
{
    ...
    /// </summary>
    public static readonly CTargetPlatform Unknown = new("unknown-unknown-unknown");
    ...
    /// </summary>
    public static readonly CTargetPlatform x86_64_scei_ps4 = new("x86_64-scei-ps4");
    ...
    ///     Nintendo 3DS (32-bit).
    /// </summary>
    public static readonly CTargetPlatform armv6k_nintendo_3ds = new("armv6k-nintendo-3ds");
    ...
    /// </summary>
    public static readonly CTargetPlatform i686_pc_windows_msvc = new("i686-pc-windows-msvc");

    /// <summary>
    ///     X64 Windows (64-bit, Windows 7+) using Microsoft's compiler and linker.
    /// </summary>
    public static readonly CTargetPlatform x86_64_pc_windows_msvc = new("x86_64-pc-windows-msvc");

    /// <summary>
    ///     ARM64 Windows (64-bit) using Microsoft's compiler and linker.
    /// </summary>
    public static readonly CTargetPlatform aarch64_pc_windows_msvc = new("aarch64-pc-windows-msvc");

    /// <summary>
    ///     X86 Windows (32-bit, Windows 7+) using GNU's Compiler Collection (GCC).
    /// </summary>
    public static readonly CTargetPlatform i686_pc_windows_gnu = new("i686-pc-windows-gnu");

    /// <summary>
    ///     X64 Windows (64-bit, Windows 7+) using GNU's Compiler Collection (GCC).
    /// </summary>
    public static readonly CTargetPlatform x86_64_pc_windows_gnu = new("x86_64-pc-windows-gnu");

    /// <summary>
    ///     ARM64 Windows (64-bit) using GNU's Compiler Collection (GCC).
    /// </summary>
    public static readonly CTargetPlatform aarch64_pc_windows_gnu = new("aarch64-pc-windows-gnu");
    ...
    /// </summary>
    public static readonly CTargetPlatform i686_unknown_linux_gnu = new("i686-unknown-linux-gnu");

    /// <summary>
    ///     X64 Linux (64-bit, kernel 2.6.32+, glibc 2.11+).
    /// </summary>
    public static readonly CTargetPlatform x86_64_unknown_linux_gnu = new("x86_64-unknown-linux-gnu");

    /// <summary>
    ///     ARM64 Linux (64-bit, kernel 4.2, glibc 2.17+).
    /// </summary>
    public static readonly CTargetPlatform aarch64_unknown_linux_gnu = new("aarch64-unknown-linux-gnu");
    ...
    /// </summary>
    public static readonly CTargetPlatform i686_apple_darwin = new("i686-apple-darwin");

    /// <summary>
    ///     X64 macOS (64-bit, 10.7+, Lion+).
    /// </summary>
    public static readonly CTargetPlatform x86_64_apple_darwin = new("x86_64-apple-darwin");

    /// <summary>
    ///     ARM64 macOS (64-bit, 11.0+, Big Sur+).
    /// </summary>
    public static readonly CTargetPlatform aarch64_apple_darwin = new("aarch64-apple-darwin");
    ...
    ///     ARM64 iOS (64-bit).
    /// </summary>
    public static readonly CTargetPlatform aarch64_apple_ios = new("aarch64-apple-ios");
    ...
    /// </summary>
    public static readonly CTargetPlatform aarch64_linux_android = new("aarch64-linux-android");

    /// <summary>
    ///     ARM32 (ARMv7) Android (32-bit).
    /// </summary>
    public static readonly CTargetPlatform arm_linux_androideabi = new("arm-linux-androideabi");

    /// <summary>
    ///     X86 Android (32-bit).
    /// </summary>
    public static readonly CTargetPlatform i686_linux_android = new("i686-linux-android");

    /// <summary>
    ///     X64 Android (64-bit).
    /// </summary>
    public static readonly CTargetPlatform x86_64_linux_android = new("x86_64-linux-android");
    ...
    ///     WebAssembly (32-bit).
    /// </summary>
    public static readonly CTargetPlatform wasm32_unknown_unknown = new("wasm32-unknown-unknown");

    /// <summary>
    ///     WebAssembly via Emscripten (32-bit).
    /// </summary>
    public static readonly CTargetPlatform wasm32_unknown_emscripten = new("wasm32-unknown-emscripten");
